  ...
  return (
    <div className="min-h-screen">
      <section className="section border-b border-primary/15 bg-black">
        <div className="container">
          <div className="max-w-5xl">
            ...
            <h1 className="mb-6 text-5xl font-black text-white md:text-6xl">{t("chatbots.hero_title")}</h1>
            <p className="mb-3 max-w-4xl text-xs uppercase tracking-[0.14em] text-[#666666]">{t("chatbots.hero_subtitle")}</p>
            <p className="mb-8 max-w-4xl text-xs uppercase tracking-[0.14em] text-[#666666]">{t("chatbots.hero_description")}</p>
      ...
      <section className="section bg-[#050505]">
        <div className="container">
          <h2 className="mb-10 text-center text-3xl font-black text-white">{t("chatbots.platforms.title")}</h2>
          <div className="mx-auto grid max-w-4xl grid-cols-2 gap-6 md:grid-cols-4">
            {platformIcons.map((platform) => {
              const Icon = platform.icon;
              return (
                <Card key={platform.key} className="sharp-card border-[#171717] bg-black py-7 text-center">
                  <div className={`mx-auto mb-3 flex h-12 w-12 items-center justify-center border border-primary/30 bg-primary/10 ${platform.color}`}>
                    <Icon className="h-5 w-5" />
                  </div>
                  <h3 className="text-xs font-black uppercase tracking-[0.14em] text-white">{t(`chatbots.platforms.${platform.key}`)}</h3>
                </Card>
              );
            })}
          </div>
      ...
      <section className="section bg-black">
        <div className="container">
          <h2 className="mb-10 text-center text-3xl font-black text-white">{t("chatbots.who_its_for.title")}</h2>
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-7 lg:grid-cols-2">
            <Card className="sharp-card border-primary/35 bg-[#050505]">
            ...
            <Card className="sharp-card border-[#272727] bg-[#050505]">
      ...
      <section className="section bg-[#050505]">
        <div className="container">
          <h2 className="mb-12 text-center text-3xl font-black text-white">{t("chatbots.problem_solution.title")}</h2>
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-3">
            <Card className="sharp-card border-red-500/40 bg-black">
              <AlertTriangle className="mb-4 h-5 w-5 text-red-400" />
              <h3 className="mb-3 text-lg font-black text-red-400">{t("chatbots.problem_solution.problem_title")}</h3>
              <p className="text-xs uppercase tracking-[0.1em] text-[#6f6f6f]">{t("chatbots.problem_solution.problem_text")}</p>
            </Card>
            <Card className="sharp-card border-primary/40 bg-black">
              <Lightbulb className="mb-4 h-5 w-5 text-primary" />
              <h3 className="mb-3 text-lg font-black text-primary">{t("chatbots.problem_solution.solution_title")}</h3>
              <p className="text-xs uppercase tracking-[0.1em] text-[#6f6f6f]">{t("chatbots.problem_solution.solution_text")}</p>
            </Card>
            <Card className="sharp-card border-secondary/40 bg-black">
              <Trophy className="mb-4 h-5 w-5 text-secondary" />
              <h3 className="mb-3 text-lg font-black text-secondary">{t("chatbots.problem_solution.result_title")}</h3>
              <p className="text-xs uppercase tracking-[0.1em] text-[#6f6f6f]">{t("chatbots.problem_solution.result_text")}</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-black">
        <div className="container">
          ...
          <div className="mx-auto grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-2">
            {benefits.map((key) => (
              <Card key={key} className="sharp-card border-[#171717] bg-[#050505]">
                <div className="flex items-start gap-3">
                  <Check className="mt-0.5 h-5 w-5 flex-shrink-0 text-primary" />
                  <div>
                    <h3 className="mb-2 text-base font-black text-white">{t(`chatbots.benefits.${key}.title`)}</h3>
                    <p className="text-xs uppercase tracking-[0.1em] text-[#6b6b6b]">{t(`chatbots.benefits.${key}.description`)}</p>
                  </div>
                </div>
              </Card>
            ))}
      ...
      <section className="section bg-[#050505]">
        <div className="container">
          <h2 className="mb-10 text-center text-3xl font-black text-white">{t("chatbots.trust_signals.title")}</h2>
      ...
      <section className="section bg-black">
        <div className="container">
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-7 md:grid-cols-3">
            {packages.map((pkg) => (
              <Card key={pkg.key} className={`sharp-card relative border bg-[#050505] ${pkg.recommended ? "border-primary" : "border-[#171717]"}`}>
                {pkg.recommended ? (
                ...
                <h3 className="mb-2 text-2xl font-black text-white">{t(`chatbots.packages.${pkg.key}.name`)}</h3>
                <div className="mb-6 text-2xl font-black text-primary">{t(`chatbots.packages.${pkg.key}.price`)}</div>
      ...
      <section className="section bg-[#050505]">
        <div className="container">
          <h2 className="mb-10 text-center text-3xl font-black text-white">{t("chatbots.faq.title")}</h2>
      ...
      <section className="section bg-gradient-to-b from-black via-primary/10 to-black">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="mb-6 text-4xl font-black text-white">{t("chatbots.cta_section.title")}</h2>
            <p className="mb-8 text-xs uppercase tracking-[0.16em] text-[#787878]">{t("chatbots.cta_section.description")}</p>
            <Button size="lg" asChild className="px-10">
              <Link href="/contact">
