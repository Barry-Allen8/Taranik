  ...
  return (
    <div className="min-h-screen">
      <section className="section border-b border-slate-700/45">
        <div className="container">
          <div className="max-w-5xl">
            ...
            <h1 className="mb-6 text-5xl text-slate-100 md:text-6xl">{t("mobile_apps.hero_title")}</h1>
            <p className="mb-3 max-w-4xl text-lg leading-relaxed text-slate-400">{t("mobile_apps.hero_subtitle")}</p>
            <p className="mb-8 max-w-4xl text-base leading-relaxed text-slate-400">{t("mobile_apps.hero_description")}</p>
      ...
      <section className="section bg-[#030b1f]/45">
        <div className="container">
          <h2 className="mb-10 text-center text-3xl text-slate-100">{t("mobile_apps.who_its_for.title")}</h2>
      ...
      <section className="section">
        <div className="container">
          <h2 className="mb-12 text-center text-3xl text-slate-100">{t("mobile_apps.problem_solution.title")}</h2>
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-3">
            <Card className="border-red-500/45 bg-slate-900/45">
              <AlertTriangle className="mb-4 h-5 w-5 text-red-300" />
              <h3 className="mb-3 text-xl text-red-300">{t("mobile_apps.problem_solution.problem_title")}</h3>
              <p className="text-sm leading-relaxed text-slate-300">{t("mobile_apps.problem_solution.problem_text")}</p>
            </Card>
            <Card className="border-primary/45 bg-slate-900/45">
              <Lightbulb className="mb-4 h-5 w-5 text-primary" />
              <h3 className="mb-3 text-xl text-primary">{t("mobile_apps.problem_solution.solution_title")}</h3>
              <p className="text-sm leading-relaxed text-slate-300">{t("mobile_apps.problem_solution.solution_text")}</p>
            </Card>
            <Card className="border-secondary/45 bg-slate-900/45">
              <Trophy className="mb-4 h-5 w-5 text-secondary" />
              <h3 className="mb-3 text-xl text-secondary">{t("mobile_apps.problem_solution.result_title")}</h3>
              <p className="text-sm leading-relaxed text-slate-300">{t("mobile_apps.problem_solution.result_text")}</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="section bg-[#030b1f]/45">
        <div className="container">
          <h2 className="mb-10 text-center text-3xl text-slate-100">{t("mobile_apps.trust_signals.title")}</h2>
            ...
            {benefits.map((benefit) => (
              <Card key={benefit.key} className="border-slate-700/45 bg-slate-900/45">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="mb-2 text-lg text-slate-100">{t(`mobile_apps.benefits.${benefit.key}.title`)}</h3>
                    <p className="text-sm leading-relaxed text-slate-400">{t(`mobile_apps.benefits.${benefit.key}.description`)}</p>
                  </div>
                </div>
              </Card>
            ))}
          ...
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-7 md:grid-cols-3">
            {packages.map((pkg) => (
              <Card key={pkg.key} className={`relative border bg-slate-900/45 ${pkg.recommended ? "border-primary" : "border-slate-700/45"}`}>
                ...
                <h3 className="mb-2 text-2xl text-slate-100">{t(`mobile_apps.packages.${pkg.key}.name`)}</h3>
                <div className="mb-6 text-2xl font-semibold text-primary">{t(`mobile_apps.packages.${pkg.key}.price`)}</div>
      ...
      <section className="section">
        <div className="container">
          <h2 className="mb-10 text-center text-3xl text-slate-100">{t("mobile_apps.faq.title")}</h2>
      ...
      <section className="section">
        <div className="container">
          <div className="mx-auto max-w-4xl rounded-[2rem] border border-slate-700/45 bg-[#07122a]/78 p-10 text-center">
            <h2 className="mb-6 text-4xl text-slate-100">{t("mobile_apps.cta_section.title")}</h2>
            <p className="mb-8 text-base leading-relaxed text-slate-300">{t("mobile_apps.cta_section.description")}</p>
            <Button size="lg" asChild className="px-10">
              <Link href="/contact">
